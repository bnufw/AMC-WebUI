...
export const DARK_THEME_IDS = ['onyx', 'graphite'] as const;
...
export const isKnownThemeId = (themeId: string): themeId is AppThemeId =>
  THEME_IDS.includes(themeId as AppThemeId);
